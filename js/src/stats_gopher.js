function StatsGopher (options) {
  ...
  if (!(('jQuery' in options) && (typeof options.jQuery.Deferred === 'function'))) {
    throw new Error("no 'jQuery.Deferred' constructor option specified")
  }
...
StatsGopher.prototype = {
  ...
  startBuffer: function () {
    ...
    this.deferred = new this.options.jQuery.Deferred()
  },
  flush: function () {
